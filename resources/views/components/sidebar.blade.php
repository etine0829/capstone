...
<div class="min-h-screen flex ">
    ...
    <!-- Sidebar -->
    <div id="sidebar" :class="{ 'w-64': open, 'w-0': !open }" class=" bg-red-dark text-yellow-dark w-64 space-y-6 px-6 py-7 absolute inset-y-0 left-0 transform -translate-x-full transition-transform duration-200 ease-in-out md:relative md:translate-x-0 z-50">
    ...
    <!-- Sidebar -->
    <div id="sidebar" class="bg-red-dark text-yellow-dark w-64 space-y-6 px-6 py-7 absolute inset-y-0 left-0 transform -translate-x-full transition-transform duration-200 ease-in-out md:relative md:translate-x-0 z-50 h-screen">
        <!-- Back Button (Visible on mobile) -->
